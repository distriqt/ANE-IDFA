...
#import "DTIDFAAIRExtensionContext.h"
...
DTIDFAAIRExtensionContext* distriqt_idfa_extContext = nil;
...
FREObject IDFA_authorisationStatus(FREContext ctx, void* funcData, uint32_t argc, FREObject argv[])
{
    FREObject result = NULL;
    @autoreleasepool
    {
        NSString* authorisationStatus = [distriqt_idfa_controller authorisationStatus];
        result = [DTFREUtils newFREObjectFromString:authorisationStatus];
    }
    return result;
}


FREObject IDFA_requestAuthorisation(FREContext ctx, void* funcData, uint32_t argc, FREObject argv[])
{
    FREObject result = NULL;
    @autoreleasepool
    {
        Boolean success = [distriqt_idfa_controller requestAuthorisation];
...
void IDFAContextInitializer(void* extData, const uint8_t* ctxType, FREContext ctx, uint32_t* numFunctionsToTest, const FRENamedFunction** functionsToSet)
{
	...
	static FRENamedFunction distriqt_idfaFunctionMap[] =
    {
        ...
        MAP_FUNCTION( IDFA_authorisationStatus, "authorisationStatus", NULL ),
        MAP_FUNCTION( IDFA_requestAuthorisation, "requestAuthorisation", NULL ),
    ...
    *functionsToSet = distriqt_idfaFunctionMap;
    ...
    distriqt_idfa_extContext = [[DTIDFAAIRExtensionContext alloc] init];
    distriqt_idfa_extContext.context = distriqt_idfa_ctx;
    
    distriqt_idfa_controller = [[DTIDFAController alloc] init];
    distriqt_idfa_controller.extContext = distriqt_idfa_extContext;
...
void IDFAContextFinalizer(FREContext ctx) 
{
    ...
    {
        distriqt_idfa_controller.extContext = nil;
        distriqt_idfa_controller = nil;
    }
    
    if (distriqt_idfa_extContext != nil)
    {
        distriqt_idfa_extContext.context = nil;
        distriqt_idfa_extContext = nil;
    }
